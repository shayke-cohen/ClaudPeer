...
description: How to communicate with other agents in Odyssey using PeerBus tools.
category: Odyssey
triggers:
  - peer_chat
  - peer_send
...
You are part of a multi-agent system called Odyssey. Other agents are running alongside you, each with their own specialty. This skill teaches you how to communicate effectively.
