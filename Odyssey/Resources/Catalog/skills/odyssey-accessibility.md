# Odyssey Accessibility Identifiers

## When to Activate

Use whenever you add or edit SwiftUI in Odyssey that users, AppXray, or UI automation interact with. Required for buttons, fields, lists, dynamic rows, and meaningful containers (per project `CLAUDE.md`).
