...
**Goal:** Add a dedicated "Workshop" view — a single place to browse, inspect, and AI-edit all Odyssey entities (agents, groups, skills, MCPs, permissions) with an embedded Config Agent chat pane.
...
|--------|------|---------------|
| Create | `Odyssey/Views/Workshop/WorkshopView.swift` | Root Workshop view: HSplitView with entity browser (left) + config chat (right) |
| Create | `Odyssey/Views/Workshop/WorkshopEntityBrowser.swift` | Tabbed entity browser: Agents / Groups / Skills / MCPs / Permissions tabs, each with search + grid/list |
| Create | `Odyssey/Views/Workshop/WorkshopEntityRow.swift` | Compact row component for entities — icon, name, enabled badge, key stats, click-to-select |
| Create | `Odyssey/Views/Workshop/WorkshopDetailPanel.swift` | Read-only detail panel for the selected entity — shows all fields in a structured layout |
| Modify | `Odyssey/App/AppState.swift:51-56` | Add `showWorkshop` published property |
| Modify | `Odyssey/Views/MainWindow/MainWindowView.swift:101-121` | Add `.sheet(isPresented: $appState.showWorkshop)` for Workshop |
| Modify | `Odyssey/Views/MainWindow/SidebarView.swift:96-154` | Add Workshop button to sidebar bottom bar |
| Test | `OdysseyTests/WorkshopViewTests.swift` | Unit tests for entity browser filtering + context injection logic |
...
**Files:**
- Modify: `Odyssey/App/AppState.swift:51-56`
- Modify: `Odyssey/Views/MainWindow/MainWindowView.swift:101-121`
- Modify: `Odyssey/Views/MainWindow/SidebarView.swift:96-154`
...
First create the directory: `mkdir -p Odyssey/Views/Workshop/`

Then create `Odyssey/Views/Workshop/WorkshopView.swift` with a minimal placeholder so the app compiles:
...
Run: `xcodegen generate && xcodebuild -scheme Odyssey -destination 'platform=macOS' build 2>&1 | tail -5`
...
```bash
git add Odyssey/App/AppState.swift Odyssey/Views/MainWindow/MainWindowView.swift Odyssey/Views/MainWindow/SidebarView.swift Odyssey/Views/Workshop/WorkshopView.swift
...
**Files:**
- Create: `Odyssey/Views/Workshop/WorkshopEntityBrowser.swift`
...
```bash
git add Odyssey/Views/Workshop/WorkshopEntityBrowser.swift
...
**Files:**
- Create: `Odyssey/Views/Workshop/WorkshopEntityRow.swift`
...
```bash
git add Odyssey/Views/Workshop/WorkshopEntityRow.swift
...
**Files:**
- Create: `Odyssey/Views/Workshop/WorkshopDetailPanel.swift`
...
```bash
git add Odyssey/Views/Workshop/WorkshopDetailPanel.swift
...
**Files:**
- Modify: `Odyssey/Views/Workshop/WorkshopView.swift` (replace placeholder)
...
```bash
git add Odyssey/Views/Workshop/WorkshopView.swift
...
**Files:**
- Modify: `Odyssey/Views/Workshop/WorkshopView.swift`
...
**Files:**
- Modify: `Odyssey/Views/Workshop/WorkshopEntityRow.swift`
...
```bash
git add Odyssey/Views/Workshop/WorkshopEntityRow.swift Odyssey/Views/Workshop/WorkshopEntityBrowser.swift
...
**Files:**
- Modify: `Odyssey/Views/Workshop/WorkshopEntityBrowser.swift`
...
**Files:**
- Create: `OdysseyTests/WorkshopViewTests.swift`
...
Run: `xcodebuild test -scheme Odyssey -destination 'platform=macOS' -only-testing:OdysseyTests/WorkshopViewTests 2>&1 | tail -10`
...
```bash
git add OdysseyTests/WorkshopViewTests.swift
