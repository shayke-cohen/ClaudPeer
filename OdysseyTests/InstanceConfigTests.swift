...
final class InstanceConfigTests: XCTestCase {
    ...
    func testBaseDirectoryContainsInstanceName() {
        ...
        XCTAssertTrue(path.contains(".odyssey/instances/\(InstanceConfig.name)"),
    ...
    func testUserDefaultsSuiteContainsInstanceName() {
        ...
        XCTAssertTrue(InstanceConfig.userDefaultsSuiteName.hasPrefix("com.odyssey.app."))
    }
    ...
    func testUserDefaultsIsNotStandard() {
        ...
        let testKey = "odyssey.test.instanceConfigTest.\(UUID().uuidString)"
    ...
    func testAppSettingsStoreMatchesInstanceDefaults() {
        let testKey = "odyssey.test.storeMatch.\(UUID().uuidString)"
