...
final class RichChatComponentTests: XCTestCase {
    ...
    func testChatDisplaySettingsKeysExist() {
        XCTAssertEqual(AppSettings.renderMermaidKey, "odyssey.chat.renderMermaid")
        XCTAssertEqual(AppSettings.renderHTMLKey, "odyssey.chat.renderHTML")
        XCTAssertEqual(AppSettings.renderDiffsKey, "odyssey.chat.renderDiffs")
        XCTAssertEqual(AppSettings.renderTerminalKey, "odyssey.chat.renderTerminal")
        XCTAssertEqual(AppSettings.renderAdmonitionsKey, "odyssey.chat.renderAdmonitions")
        XCTAssertEqual(AppSettings.renderPDFKey, "odyssey.chat.renderPDF")
        XCTAssertEqual(AppSettings.showSessionSummaryKey, "odyssey.chat.showSessionSummary")
        XCTAssertEqual(AppSettings.showSuggestionChipsKey, "odyssey.chat.showSuggestionChips")
    }
